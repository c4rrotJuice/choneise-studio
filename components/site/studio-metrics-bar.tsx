...
/* ------------------------------------------------------------------ */
/*  Inline SVG icons (stroke-first, small, understated)                */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/*  Static metrics (Cloudflare-safe, no DB)                            */
/* ------------------------------------------------------------------ */
...
export function StudioMetricsBar() {
  return (
    <div className={styles.root} aria-label="Studio metrics">
      <MetricItem
        icon={<IconProjects />}
        value={String(STATIC_METRICS.totalProjects)}
        label="Projects"
      />
      <MetricItem
        icon={<IconExperiment />}
        value={String(STATIC_METRICS.activeExperiments)}
        label="Active"
        sublabel="Experiments"
      />
      <MetricItem
        icon={<IconProduction />}
        value={String(STATIC_METRICS.productionSystems)}
        label="Production"
        sublabel="Systems"
      />
      <MetricItem
